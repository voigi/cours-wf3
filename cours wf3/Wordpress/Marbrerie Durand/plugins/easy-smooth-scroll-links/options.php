<div class="wrap">
  ...
  <ul> 
<li>
      <a href="https://wordpress.org/support/plugin/easy-smooth-scroll-links/reviews/#new-post" target="_blank" rel="noopener">Reviews keep this plugin free. Please leave a review! Thank you 👍
      </a>
    </li>	
    <li>
...
<tfoot>		   
  <tr>			 
    <th>
      <p class="alignleft"><input type="submit" name="submit" value="Save Settings" class="button button-primary" onClick="return empty()"></p>
    </th>		   
  </tr>		
</tfoot>	
</table>	
